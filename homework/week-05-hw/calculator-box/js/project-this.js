...
//in the function above, you had to look for
//the div that has the math class for which 
//box is clicked

//then you need to create an anon function where
//you define a variable that will end up being a
//number

//you need to parse that number, then redefine
//total as being itself plus this variable that
//has the number.
